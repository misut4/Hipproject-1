    ...
    <div className={state}>
      <div className="absolute border rounded-lg bg-white shadow-2xl w-80 h-[25rem] -left-[17.5rem] top-[1.2rem] z-10">
        <div className="flex flex-col justify-between h-full">
          ...
          <div className=" text-blue-800 font-semibold border-t border-t-gray-300  h-14 flex justify-center items-center hover:bg-blue-100 transition-all cursor-pointer">
            <h1>Sign Out</h1>
          </div>
        </div>
      </div>
